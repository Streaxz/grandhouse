	...
	return (
		<div className={'packages'}>
			...
			<div className={'packagesItem'}>
				...
				<p style={{color: "#272B40"}}>Коробка дома (фундамент – монолитная ж/б плита; разводка внутренней канализации,
					закладные детали ввода и вывода инженерных коммуникаций; стены/перегородки – двойной керамический кирпич,
					вентиляционная шахта – рядовой керамический кирпич; чердачное перекрытие – деревянные балки; покрытие кровли –
					металлочерепица, снегозадержатели, вентиляционные аэраторы)</p>
			</div>
			{price.features.map((feature) => (
				<div
					key={`feature-${random()}`}
					className={'packagesItem'}
				>
					<img className={'confirmIcon'} src={'/confirm.png'} alt={'Преимущество'}/>
			...
			<div className={'packagesFooter'}>
				...
				<p style={{color: "#62698C", textWrap: "nowrap"}}>Построим за {price.estimate}</p>
			</div>
		</div>
	)
}