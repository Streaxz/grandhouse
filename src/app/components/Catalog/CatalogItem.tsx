...
export const CatalogItem = ({isArchive, project}: IAutumnProject) => {
    return (
      <div style={{maxHeight: "468px", display: "flex", flexDirection: "column"}}>
          <div
            className='catalogPhoto'
            style={{backgroundImage: `url(${project?.photos?.filter((photo) => photo.type === PHOTO_TYPE.GENERAL)[0]?.imageUrl || ''})`,}}
          >
          ...
          <div className='photoFooter'>
              <div style={{display: "flex", textAlign: "center"}}>
                  <h6 className={'footerText h3'}>
                      Общая {project?.area} м²
                  </h6>
              </div>
              <div className={'separateLine'}/>
              <div style={{display: "flex", textAlign: "center"}}>
                  <h6 className={'footerText h6'}>
                      Жилая {project?.size} м²
                  </h6>
              </div>
              <div className={'separateLine'}/>
              {/*<div style={{display: "flex", textAlign: "center"}}>*/}
              ...
              <div style={{display: "flex", textAlign: "center"}}>
                  <h6 className={'footerText h6'}>
                      {project?.bedroomsCount} сп.
                  </h6>
              </div>
              <div className={'separateLine'}/>
              <div style={{display: "flex", textAlign: "center"}}>
                  <h6 className={'lastFooterText h6'}>
                      {project?.bathroomCount} c/у
                  </h6>
              </div>
