	...
	return (
		<div className={'magazineCardLarge'}>
				...
				<div className={'magazineCardLargeContent'}>
						...
						<p style={{color: "#272B40", height: "-webkit-fill-available"}}>Портфолио Грандхауса включает дома и объекты различной сложности, построенные по всей Западной России. </p>
