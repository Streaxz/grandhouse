		...
		return (
			<div className={'filters'}>
					<div className={'buttonsContainer'}>
							...
							>
									<span className={'filtersButtonText'} style={{fontWeight: 300}}>Все проекты</span>
									<h6 style={{textAlign: "left"}}>150 шт.</h6>
							</button>
							<button className='filtersButton'
											style={{display: "flex", flexDirection: "column"}}
							>
									<span className={'filtersButtonText'} style={{fontWeight: 300}}>Из дерева</span>
									<h6>150 шт.</h6>
							</button>
							<button className='filtersButton'
											style={{display: "flex", flexDirection: "column"}}
							>
									<span className={'filtersButtonText'} style={{fontWeight: 300}}>Из камня</span>
									<h6>150 шт.</h6>
							</button>
							<button className='filtersButton'
											style={{display: "flex", flexDirection: "column", overflow: "hidden", textOverflow: "ellipsis"}}
							>
									<span className={'filtersButtonText'}
												style={{fontWeight: 300, overflow: "hidden", textOverflow: "ellipsis"}}>Комбинированные</span>
									<h6>150 шт.</h6>
							</button>
					</div>
							...
							<div className={'specials'}>
									...
									<div className={'checkboxContainer'}>
											<FormControlLabel
												...
												label={<h5 style={{color: '#62698C', textWrap: "nowrap", paddingTop: "4px",}}>С цокольным
														этажом</h5>}
											/>
											<FormControlLabel
												style={{width: "fit-content"}}
												...
												label={<h5 style={{color: '#62698C', textWrap: "nowrap", paddingTop: "4px",}}>С гаражом</h5>}
											/>
											<FormControlLabel
												style={{width: "fit-content"}}
												control={
												...
												label={<h5 style={{color: '#62698C', textWrap: "nowrap", paddingTop: "4px",}}>Показать
														индивидуальные</h5>}
											/>
											<FormControlLabel
												style={{width: "fit-content"}}
