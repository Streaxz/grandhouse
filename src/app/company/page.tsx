			...
			<main className={styles.page}>
					<div className={`${styles.pageWrapper} ${styles.lightGradient}`}>
							<div className={styles.pageContainer}>
									...
									<Carousel
										...
										isPagination={true}
									>
											<FeatureCardPicture src={"/company.jpeg"} descriptionText={"Подпись"}/>
											<FeatureCardPicture src={"/company.jpeg"} descriptionText={"Подпись"}/>
									</Carousel>
							</div>
					</div>
					...
					<div className={`${styles.pageWrapper} ${styles.darkGradient}`}>
							<div className={styles.pageContainer}>
									...
									<EmployeeCardLarge
										src={'/worker.jpeg'}
										headerText={"Имя Фамилия, строили с нами 150-метровый каменный дом по проекту “Грандхаус-1” в Московской области"}
										descriptionText={"Небольшой отзыв от одной  из семей, построивших дом своей мечты с Грандхаусом. Лаконичная благо-желательная цитата, описывающая, насколько довольна семья работой компании и взаимодействием с ее сотрудниками"}
										link={"/"}
									/>
									<PhotoButton
